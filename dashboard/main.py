...
all_df = pd.read_csv("C:/Users/aziz/PycharmProjects/pythonProject1/E-Commerce Data Analysis/data/all_data.csv")
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Geolocation Dataset
geolocation = pd.read_csv('C:/Users/aziz/PycharmProjects/pythonProject1/E-Commerce Data Analysis/data/geolocation.csv')
